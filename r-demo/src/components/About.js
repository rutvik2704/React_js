...
// })
// const [btntext, setBtnText] = useState("Enable Light Moder")
// const  togglestyle = ()=>{
...
//     })
//     setBtnText("Enable Dark Moder")
// } else {
//     setMystyle({
//         color:'black',
//         backgroundColor:'white'
//     })
//     setBtnText("Enable Light Moder")
                ...
                <div className="accordion" id="accordionExample">
                    ...
                    <div className="accordion-item">
                        <h2 className="accordion-header" id="headingThree">
                            <button className="accordion-button collapsed" type="button"  style={{ backgroundColor: props.mode==='dark'?'black':'white',color:props.mode==='dark'?'white':'black'}} data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                Accordion Item #3
                            </button>
                        </h2>
